  ...
  <div class="row d-flex justify-content-center">
    <form class="col-lg-6 border p-3 mt-5 form-to-handle" action="register.php" method="post" novalidate>
      <div class="mb-3 input-div">
        ...
        <input type="text" class="form-control required <?php echo $nameClass ?>"
        maxlength="36" id="inputName" name="login" value="<?php echo $validity["login"][2] ?>">
        <div class="invalid-feedback feedback"><?php echo $validity["login"][1] ?></div>
      </div>
      <div class="mb-3 input-div">
        <label for="exampleInputEmail1" class="form-label">Email</label>
        <input type="email" class="form-control required <?php echo $emailClass ?>" id="exampleInputEmail1" name="email" value="<?php echo $validity["email"][2] ?>">
        <div class="invalid-feedback feedback"><?php echo $validity["email"][1] ?></div>
      </div>
      <div class="mb-3 input-div">
        <label for="exampleInputPassword1" class="form-label">Пароль</label>
        <input type="password" class="form-control required <?php echo $passwordClass ?>" id="exampleInputPassword1" name="password" value="<?php echo $validity["password"][2] ?>">
      ...
      <div class="mb-3 input-div">
        ...
        <input type="password" class="form-control required <?php echo $passwordConfirmClass ?>" id="confirmPassword1" name="passwordConfirm" value="<?php echo $validity["passwordConfirm"][2] ?>">
